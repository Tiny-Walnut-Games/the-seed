...
def main():
    ...
    # Set working directory to engine folder
    engine_dir = Path("Packages/com.twg.the-seed/seed/engine")
    ...
    if args.gui:
        ...
        cmd = [sys.executable, "-m", "pytest", str(engine_dir / "test_seed_pytest.py"), "-v"]
        ...
        cmd = [sys.executable, str(engine_dir / "seed_test_suite.py")]
