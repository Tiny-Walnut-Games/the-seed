...
Minimal addressable unit containing full context

Storage primitive

**STAT7**

7-dimensional addressing space

Coordinate system

**LUCA**

Irreducible ground state; primordial unit

Bootstrap origin

**Luminosity**

Activity level and compression distance from LUCA

Time/heat axis

**Polarity**

Charge, alignment, or resonance pattern

Connection metric

**Entanglement**

Non-local relationship between distant bit-chains

Relational topology

**Horizon**

Lifecycle stage (genesis→peak→crystallization)

State axis

**Adjacency**

Semantic/functional proximity (not spatial)

Relational graph

**Realm**

Domain classification (data/narrative/system/etc)

Structural axis

**Lineage**

Generation number from LUCA
