    ...
    public static class TLDANFTBridge
    {
        ...
        public static NFTMintResult ProcessRitual(TLDARitualEvent ritualEvent)
        {
            try
            {
                ...
                return NFTMintResult.Success(spriteResult, mintData, ledgerEntry);
            }
            catch (Exception ex)
            {
        ...
        private static string GenerateTLDASeed(TLDARitualEvent ritualEvent)
        {
            ...
            return System.Security.Cryptography.SHA256.HashData(System.Text.Encoding.UTF8.GetBytes(combined))
        ...
        private static string GenerateUnitySpriteMetaFile(SpriteGenerationResult result)
        {
            ...
            var frameSize = result.AnimationData.FrameRects[0];
...
TextureImporter:
  ...
  assetBundleVariant: ";
    ...
    public class NFTMintResult
    {
        ...
        public static NFTMintResult Success(SpriteGenerationResult spriteResult, MintTransactionData mintData, TLDALedgerEntry ledgerEntry)
        {
