...
namespace TWG.TLDA.SpriteForge
{
    ...
    public class SpriteSpec
    {
        ...
        public Dictionary<string, object> CustomTraits = new Dictionary<string, object>();
    ...
    public class SpriteAnimationData
    {
        ...
        public Vector2 Pivot = new Vector2(0.5f, 0f); // Bottom-center
        ...
        public AnimationClip ToAnimationClip(Sprite[] sprites)
        {
            ...
            clip.name = $"{AnimationType}_Animation";
            clip.frameRate = 8f; // 8 FPS for pixel art
