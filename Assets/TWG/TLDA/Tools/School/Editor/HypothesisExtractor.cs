...
namespace TWG.TLDA.School.Editor
{
    ...
    public class HypothesisDrafts
    {
        ...
        public string SourceInventoryHash { get; set; }
    ...
    public class Hypothesis
    {
        ...
        public string FacultySurfacePath { get; set; }
        public string FacultySurfaceType { get; set; }
        public string Type { get; set; } // "CapabilityAssertion" or "ImprovementTarget"
