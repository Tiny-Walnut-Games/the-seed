...
namespace TWG.TLDA
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        private List<string> _gameFlags = new List<string>();
        ...
        private void InitializeGame()
        {
            ...
            _gameData["startTime"] = DateTime.Now;
            _gameData["version"] = Application.version;
        ...
        {
            if (!_gameFlags.Contains(flagName))
            {
                _gameFlags.Add(flagName);
        ...
        {
            return _gameFlags.Contains(flagName);
        }
        ...
        public Dictionary<string, object> GetWorldState()
        {
            return new Dictionary<string, object>
            {
                ...
                {"flags", new List<string>(_gameFlags)}
            };
        }
        ...
        public void SaveGame()
        {
            ...
            PlayerPrefs.SetString("GameFlags", string.Join(",", _gameFlags));
        ...
        public void LoadGame()
        {
            if (PlayerPrefs.HasKey("PlayerLevel"))
            {
                ...
                {
                    _gameFlags = new List<string>(flagsString.Split(','));
                }
