...
namespace LivingDevAgent.Runtime.CompanionBattler
{
    ...
    public class CompanionBattleUI : MonoBehaviour
    {
        ...
        // UI state
        private List<Companion> availableCompanions = new List<Companion>();
        private List<Companion> selectedTeam = new List<Companion>();
        ...
        private void CreateCompanionCard(Companion companion)
        {
            ...
            CompanionCard card = cardObj.GetComponent<CompanionCard>();
        ...
        {
            GameObject statusObj = new GameObject($"{companion.Name}_Status");
            statusObj.transform.SetParent(parent);

            // Add companion status UI components
            var canvas = statusObj.AddComponent<Canvas>();
            var canvasGroup = statusObj.AddComponent<CanvasGroup>();
        ...
        {
            GameObject barObj = new GameObject($"{name}Bar");
        ...
        private Transform FindCompanionStatusDisplay(Companion companion)
        {
            ...
            Transform found = playerTeamDisplay?.Find($"{companion.Name}_Status");
            if (found == null)
        ...
        private Color GetElementColor(CompanionElement element)
        {
            switch (element)
            {
                case CompanionElement.Logic: return Color.blue;
                case CompanionElement.Creativity: return Color.magenta;
                case CompanionElement.Order: return Color.white;
                case CompanionElement.Chaos: return Color.red;
                case CompanionElement.Balance: return Color.gray;
        ...
        private void SetupEvolutionCeremony(Companion companion)
        {
            ...
            {
                var spriteRenderer = companion.GetComponent<SpriteRenderer>();
