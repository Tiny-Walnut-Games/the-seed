...
namespace LivingDevAgent.Runtime.CompanionBattler
{
    ...
    public class CompanionAbility
    {
        ...
        public List<string> battleQuips = new();
        ...
        private bool ShouldApplyArchetypeBonus(CompanionArchetype archetype)
        {
            ...
            {
                BattleEffectType.Damage => archetype == CompanionArchetype.Striker,
                BattleEffectType.Heal or BattleEffectType.Buff => archetype == CompanionArchetype.Support,
                BattleEffectType.Debuff or BattleEffectType.Status => archetype == CompanionArchetype.Controller,
                _ => archetype == CompanionArchetype.Hybrid,
            };
        }
    }
}
