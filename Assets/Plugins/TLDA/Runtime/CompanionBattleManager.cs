...
namespace LivingDevAgent.Runtime.CompanionBattler
{
    ...
    public class CompanionBattleManager : MonoBehaviour
    {
        ...
        [Header("Teams")]
        [SerializeField] private List<Companion> playerTeam = new List<Companion>();
        [SerializeField] private List<Companion> enemyTeam = new List<Companion>();
        ...
        private Queue<Companion> turnQueue = new Queue<Companion>();
        ...
        private void CalculateTurnOrder()
        {
            ...
            List<Companion> allCompanions = new List<Companion>();
