...
namespace MobileGameTemplate.Systems
{
    ...
    public class MockAdPlatform : IAdMediationPlatform
    {
        ...
        private readonly System.Collections.Generic.Dictionary<AdType, bool> _adAvailability = 
            new();
        ...
        public void ShowAd(AdType adType, string rewardContext)
        {
            ...
            MonoBehaviour.FindFirstObjectByType<AdsSystem>().StartCoroutine(
    ...
    public static class AdPlacements
    {
        ...
        public static AdReward GetRecommendedReward(string context)
        {
            return context switch
            {
                ...
                UNLOCK_FEATURE => new AdReward { rewardType = AdRewardType.Unlock, quantity = 1, description = "Unlock premium feature!" },
