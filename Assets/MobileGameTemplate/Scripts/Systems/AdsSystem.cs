...
namespace MobileGameTemplate.Systems
{
    ...
    public class AdButton : VisualElement
    {
        ...
        public AdButton(AdType adType, string rewardContext = "")
        {
            ...
            _adsSystem = FindObjectOfType<AdsSystem>();
        ...
        private void CreateButtonStructure()
        {
            ...
            _rewardIcon.style.borderRadius = 16;
            ...
            _watchButton.style.borderRadius = 8;
            _watchButton.style.borderWidth = 0;
        ...
        private void OnAdRewardGranted(AdType adType, AdReward reward)
        {
            if (adType == _adType)
            {
                ...
                // Visual feedback
                style.borderColor = new Color(1f, 0.8f, 0f, 1f);
        ...
        {
            UxmlEnumAttributeDescription<AdType> _adType = new UxmlEnumAttributeDescription<AdType> 
            { 
                name = "ad-type", 
                defaultValue = AdType.RewardedVideo 
            };
            
            UxmlStringAttributeDescription _rewardContext = new UxmlStringAttributeDescription 
            { 
                name = "reward-context", 
                defaultValue = "" 
            };
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                var adButton = ve as AdButton;
                if (adButton != null)
                {
                    // Reinitialize with UXML attributes
                    adButton._adType = _adType.GetValueFromBag(bag, cc);
                    adButton._rewardContext = _rewardContext.GetValueFromBag(bag, cc);
                    adButton.UpdateButtonState();
                }
            }
        }
    }
...
// Continue with data structures and platform wrappers...