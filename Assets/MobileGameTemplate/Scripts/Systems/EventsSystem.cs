...
namespace MobileGameTemplate.Systems
{
    ...
    public class EventsSystem : VisualElement
    {
        ...
        private void SetupEventsStructure()
        {
            ...
            // Note: borderRadius is not available in Unity UIToolkit - using background instead
        ...
        private Button CreateTab(string label, EventCategory category)
        {
            ...
            // Note: borderWidth and borderRadius not available in Unity UIToolkit for buttons
        ...
        private void SetupNotificationPanel()
        {
            ...
            _notificationPanel.style.backgroundColor = new Color(0.05f, 0.05f, 0.05f, 0.9f);
            // Note: UIToolkit doesn't support borderRadius and borderColor directly
            _notificationPanel.style.paddingTop = 16;
            _notificationPanel.style.paddingBottom = 16;
            _notificationPanel.style.paddingLeft = 16;
            _notificationPanel.style.paddingRight = 16;
        ...
        private bool FilterEventByCategory(GameEvent gameEvent, EventCategory category)
        {
            ...
            {
                EventCategory.Active => gameEvent.IsActive() && !gameEvent.isCompleted,
                EventCategory.Daily => gameEvent.eventType == EventType.Daily,
                EventCategory.Seasonal => gameEvent.eventType == EventType.Seasonal || gameEvent.eventType == EventType.LimitedTime,
                EventCategory.Achievement => gameEvent.eventType == EventType.Achievement,
                _ => true,
            };
        }
        ...
        private VisualElement CreateEventCard(GameEvent gameEvent)
        {
            ...
            // Note: borderRadius and borderColor not available - using background instead
            ...
            // Note: borderRadius not available in Unity UIToolkit
        ...
        private VisualElement CreateActionsSection(GameEvent gameEvent)
        {
            ...
            if (!gameEvent.hasStarted && gameEvent.IsActive())
            {
                ...
                // Note: borderRadius and borderWidth not available in Unity UIToolkit
        ...
        // Note: UxmlFactory pattern is obsolete in newer Unity UI Toolkit versions
        // Modern approach uses custom elements without explicit factory registration
    ...
    // Data structures for events system
    [System.Serializable]
