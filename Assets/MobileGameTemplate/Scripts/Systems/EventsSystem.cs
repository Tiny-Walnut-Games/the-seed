...
namespace MobileGameTemplate.Systems
{
    ...
    public class EventsSystem : VisualElement
    {
        ...
        private void SetupEventsStructure()
        {
            ...
            _notificationBadge.style.borderRadius = 10;
        ...
        private void SetupNotificationPanel()
        {
            ...
            _notificationPanel.style.borderRadius = 12;
            _notificationPanel.style.borderWidth = 1;
            _notificationPanel.style.borderColor = new Color(0.2f, 0.2f, 0.2f, 0.8f);
        ...
        private VisualElement CreateEventCard(GameEvent gameEvent)
        {
            ...
            card.style.borderColor = GetEventStatusColor(gameEvent);
            ...
            eventCategory.style.borderRadius = 4;
            ...
            priorityIndicator.style.borderRadius = 4;
        ...
        private VisualElement CreateRewardsSection(GameEvent gameEvent)
        {
            ...
            if (gameEvent.rewards.Count > 0)
            {
                ...
                foreach (var reward in gameEvent.rewards)
                {
                    ...
                    rewardChip.style.borderRadius = 8;
        ...
        private VisualElement CreateActionsSection(GameEvent gameEvent)
        {
            ...
            if (!gameEvent.hasStarted && gameEvent.IsActive())
            {
                ...
                startButton.style.borderWidth = 0;
            ...
            if (gameEvent.isCompleted && !gameEvent.rewardsClaimed)
            {
                ...
                claimButton.style.borderRadius = 8;
                claimButton.style.borderWidth = 0;
            ...
            detailsButton.style.borderWidth = 0;
