...
namespace MobileGameTemplate.Systems
{
    ...
    public class InventorySlot : VisualElement
    {
        ...
        private readonly VisualElement _rarityBorder;
        ...
        private void CreateSlotStructure()
        {
            ...
            style.borderTopColor = new Color(0.3f, 0.3f, 0.3f, 0.6f);
            style.borderRightColor = new Color(0.3f, 0.3f, 0.3f, 0.6f);
            style.borderBottomColor = new Color(0.3f, 0.3f, 0.3f, 0.6f);
            ...
            //_itemIcon.style.borderTopLeftRadius = 4;
            //_itemIcon.style.borderTopRightRadius = 4;
            //_itemIcon.style.borderBottomLeftRadius = 4;
            //_itemIcon.style.borderBottomRightRadius = 4;
        ...
        public void SetItem(InventoryItem item, ItemData itemData)
        {
            ...
            // Set rarity border
            style.borderTopColor = GetRarityColor(itemData.rarity);
            style.borderRightColor = GetRarityColor(itemData.rarity);
            style.borderBottomColor = GetRarityColor(itemData.rarity);
            style.borderLeftColor = GetRarityColor(itemData.rarity);
        }
    ...
    public class EquipmentSlot : VisualElement
    {
        ...
        private void CreateSlotStructure()
        {
            ...
            //style.borderBottomWidth = 2;
            //style.borderLeftWidth = 2;
            style.borderTopColor = new Color(0.4f, 0.4f, 0.4f, 0.8f);
            style.position = Position.Relative;
        ...
        public void SetItem(InventoryItem item, ItemData itemData)
        {
            ...
            // Set equipped border
            style.borderTopColor = new Color(0.3f, 0.7f, 0.3f, 1f);
            style.borderRightColor = new Color(0.3f, 0.7f, 0.3f, 1f);
            style.borderBottomColor = new Color(0.3f, 0.7f, 0.3f, 1f);
            style.borderLeftColor = new Color(0.3f, 0.7f, 0.3f, 1f);
        }
        ...
        public void ClearItem()
        {
            ...
            _itemIcon.style.backgroundImage = null;
            style.borderTopColor = new Color(0.4f, 0.4f, 0.4f, 0.8f);
            style.borderRightColor = new Color(0.4f, 0.4f, 0.4f, 0.8f);
            style.borderBottomColor = new Color(0.4f, 0.4f, 0.4f, 0.8f);
            style.borderLeftColor = new Color(0.4f, 0.4f, 0.4f, 0.8f);
        }
