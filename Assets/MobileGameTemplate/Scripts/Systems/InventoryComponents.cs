...
namespace MobileGameTemplate.Systems
{
    ...
    public class InventorySlot : VisualElement
    {
        ...
        private void CreateSlotStructure()
        {
            ...
            style.borderWidth = 2;
            style.borderColor = new Color(0.3f, 0.3f, 0.3f, 0.6f);
            ...
            _itemIcon.style.borderRadius = 4;
            ...
            _quantityLabel.style.borderRadius = 4;
        ...
        public void SetItem(InventoryItem item, ItemData itemData)
        {
            ...
            // Set rarity border
            style.borderColor = GetRarityColor(itemData.rarity);
        }
    ...
    public class EquipmentSlot : VisualElement
    {
        ...
        private void CreateSlotStructure()
        {
            ...
            style.borderRadius = 8;
            style.borderWidth = 2;
            style.borderColor = new Color(0.4f, 0.4f, 0.4f, 0.8f);
            style.position = Position.Relative;
        ...
        public void SetItem(InventoryItem item, ItemData itemData)
        {
            ...
            // Set equipped border
            style.borderColor = new Color(0.3f, 0.7f, 0.3f, 1f);
        }
