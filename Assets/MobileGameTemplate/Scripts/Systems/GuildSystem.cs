...
namespace MobileGameTemplate.Systems
{
    ...
    public class GuildSystem : VisualElement
    {
        ...
        private void ShowNoGuildState()
        {
            ...
            //joinButton.style.borderRadius = 8;
            //joinButton.style.borderWidth = 0;
            ...
            //createButton.style.borderRadius = 8;
            //createButton.style.borderWidth = 0;
        ...
        //        base.Init(ve, bag, cc);
        //    }
        //} // @copilot - UxmlFactory is obsolete, so we remove this, yes?
...
public class GuildData
{
    ...
    public GuildSettings settings = new();
    
    [Header("Guild Activities")]
    public List<GuildActivity> recentActivities = new();
