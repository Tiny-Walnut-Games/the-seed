...
namespace MobileGameTemplate.Systems
{
    ...
    public class InventorySystem : VisualElement
    {
        ...
        private Dictionary<string, ItemData> _allItems = new Dictionary<string, ItemData>();
        private List<InventoryItem> _playerInventory = new List<InventoryItem>();
        private Dictionary<string, InventoryItem> _equippedItems = new Dictionary<string, InventoryItem>();
        ...
        // Configuration
        private int _slotsPerRow = 6;
        private int _totalSlots = 48;
        private float _slotSize = 60f;
        private float _slotSpacing = 4f;
        ...
        private void SetupEquipmentPanel()
        {
            ...
            _equipmentPanel.style.backgroundColor = new Color(0.15f, 0.15f, 0.15f, 0.8f);
            _equipmentPanel.style.paddingTop = 12;
            _equipmentPanel.style.paddingBottom = 12;
            _equipmentPanel.style.paddingLeft = 12;
            _equipmentPanel.style.paddingRight = 12;
            ...
            _detailsPanel.style.backgroundColor = new Color(0.15f, 0.15f, 0.15f, 0.8f);
            _detailsPanel.style.paddingTop = 12;
            _detailsPanel.style.paddingBottom = 12;
            _detailsPanel.style.paddingLeft = 12;
            _detailsPanel.style.paddingRight = 12;
        ...
        private void UpdateSlotLayout()
        {
            ...
            float actualSlotSize = (availableWidth - (_slotsPerRow - 1) * _slotSpacing) / _slotsPerRow;
...
// 🔧 LEGENDARY FIX: borderColor not available in Unity 2022.3
        ...
        private void ShowItemDetails(ItemData itemData)
        {
            ...
            {
                var useButton = new Button(() => UseItem(itemData.itemId));
                useButton.text = "USE";
            ...
            {
                var equipButton = new Button(() => EquipItem(itemData.itemId, itemData.equipSlotType));
                equipButton.text = "EQUIP";
                equipButton.style.marginBottom = 4;
                buttonContainer.Add(equipButton);
            }
            
            var sellButton = new Button(() => OnItemSold?.Invoke(itemData));
            sellButton.text = $"SELL ({itemData.sellValue})";
