...
namespace MobileGameTemplate.Systems
{
    ...
    public class InventorySystem : VisualElement
    {
        ...
        private void SetupEquipmentPanel()
        {
            ...
            _equipmentPanel.style.borderRadius = 12;
            _equipmentPanel.style.borderWidth = 1;
            _equipmentPanel.style.borderColor = new Color(0.2f, 0.2f, 0.2f, 0.8f);
            ...
            _detailsPanel.style.borderRadius = 12;
            _detailsPanel.style.borderWidth = 1;
            _detailsPanel.style.borderColor = new Color(0.2f, 0.2f, 0.2f, 0.8f);
        ...
        private void CreateDragPreview(InventorySlot slot)
        {
            ...
            _dragPreview.style.borderRadius = 8;
            _dragPreview.style.borderWidth = 2;
            _dragPreview.style.borderColor = Color.white;
