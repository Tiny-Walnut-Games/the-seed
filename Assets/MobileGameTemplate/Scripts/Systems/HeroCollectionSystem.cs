...
namespace MobileGameTemplate.Systems
{
    ...
    public class HeroCollectionSystem : VisualElement
    {
        ...
        private List<HeroData> _filteredHeroes = new List<HeroData>();
        private List<HeroCollectionCard> _heroCards = new List<HeroCollectionCard>();
        ...
        private float _cardHeight = 120f;
        private float _cardSpacing = 8f;
        #endregion
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            UxmlFloatAttributeDescription _cardWidth = new UxmlFloatAttributeDescription 
            { 
                name = "card-width", 
                defaultValue = 100f 
            };
            
            UxmlFloatAttributeDescription _cardHeight = new UxmlFloatAttributeDescription 
            { 
                name = "card-height", 
                defaultValue = 120f 
            };
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                var collection = ve as HeroCollectionSystem;
                if (collection != null)
                {
    ...
    public class HeroCollectionCard : VisualElement
    {
        ...
        private void CreateCardStructure()
        {
            ...
            _background.style.borderRadius = 8;
            _background.style.borderWidth = 2;
            ...
            _heroImage.style.borderRadius = 6;
            ...
            _ownedIndicator.style.borderRadius = 6;
            ...
            _lockIcon.style.borderRadius = 15;
