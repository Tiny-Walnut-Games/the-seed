...
namespace MobileGameTemplate.Systems
{
    ...
    public class GuildInfoPanel : VisualElement
    {
        ...
        private void CreateInfoStructure()
        {
            ...
            // _activitiesContainer.style.borderRadius = 8;
        ...
        private void UpdateRecentActivities(List<GuildActivity> activities)
        {
            ...
            foreach (var activity in activities.Take(5)) // Show last 5 activities
            {
                ...
                // Note: borderRadius not available in Unity UIToolkit .NET Framework 4.7.1
                // activityIcon.style.borderRadius = 8;
    ...
    public class GuildRosterPanel : VisualElement
    {
        ...
        private List<GuildMember> _sortedMembers = new();
        ...
        private void CreateRosterStructure()
        {
            ...
            // Note: borderRadius and borderWidth not available in Unity UIToolkit .NET Framework 4.7.1
            // _inviteButton.style.borderRadius = 8;
            // _inviteButton.style.borderWidth = 0;
        ...
        private VisualElement CreateMemberCard(GuildMember member)
        {
            ...
            // Note: borderRadius not available in Unity UIToolkit .NET Framework 4.7.1
            // statusDot.style.borderRadius = 4;
            ...
            // Note: borderRadius not available in Unity UIToolkit .NET Framework 4.7.1
            // roleLabel.style.borderRadius = 4;
            ...
            if (canManage)
            {
                if (member.role == GuildRole.Member)
                {
                    ...
                    // Note: borderRadius and borderWidth not available in Unity UIToolkit .NET Framework 4.7.1
                    // promoteButton.style.borderRadius = 12;
                    // promoteButton.style.borderWidth = 0;
                ...
                if (_playerMember.role == GuildRole.Leader)
                {
                    ...
                    // Note: borderRadius and borderWidth not available in Unity UIToolkit .NET Framework 4.7.1
                    // kickButton.style.borderRadius = 12;
                    // kickButton.style.borderWidth = 0;
    ...
    public class GuildChatPanel : VisualElement
    {
        ...
        private void CreateChatStructure()
        {
            ...
            // Note: borderRadius not available in Unity UIToolkit .NET Framework 4.7.1
            // _chatHistory.style.borderRadius = 8;
            ...
            // Note: borderRadius and borderWidth not available in Unity UIToolkit .NET Framework 4.7.1
            // _sendButton.style.borderRadius = 8;
            // _sendButton.style.borderWidth = 0;
    ...
    public class GuildSettingsPanel : VisualElement
    {
        ...
        private void CreateSettingsStructure()
        {
            ...
            //_leaveGuildButton.style.borderRadius = 8;
            //_leaveGuildButton.style.borderWidth = 0;
