...
namespace MobileGameTemplate.UI
{
    ...
    public class LevelCarouselItem : VisualElement
    {
        ...
        private void CreateItemStructure()
        {
            ...
            _background.style.borderRadius = 16;
            _background.style.borderWidth = 2;
            _background.style.borderColor = new Color(0.3f, 0.3f, 0.3f, 0.8f);
            ...
            _playButton.style.borderRadius = 20;
            _playButton.style.borderWidth = 0;
            ...
            _detailsButton.style.borderRadius = 15;
            _detailsButton.style.borderWidth = 0;
        ...
        private void UpdateVisualState()
        {
            ...
            else if (_levelData.isCompleted)
            {
                ...
                _background.style.borderColor = new Color(0.3f, 0.7f, 0.3f, 0.8f);
            }
            else
            {
                _lockIcon.style.display = DisplayStyle.None;
